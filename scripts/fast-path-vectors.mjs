...
// fee-share list (0x6436), validator-entry list (0x6422) and
...
const BOND_RESOURCE_ID_TYPE_ID_EARLY = 0x8008;
const feeResourceId = frame(BOND_RESOURCE_ID_TYPE_ID_EARLY, [
  [1, uint(9, 2)],
  [2, Buffer.alloc(32, 0x09)],
]);
const feeShare = (validatorByte) => frame(FASTPATH_FEE_SHARE_TYPE_ID, [
  [1, Buffer.alloc(32, validatorByte)],
  [2, uint(500, 8)],
  [3, uint(0, 2)],
]);
const chargedShareList = list(FASTPATH_FEE_SHARE_LIST_TYPE_ID, [feeShare(0x05), feeShare(0x06)]);
...
const expected = {
  ...
  fastpathSettlementRecordCharged0x641e: '',
  fastpathFeeShareListCharged0x6436: '',
