...
// ---- FeeClaimIntent 0x6437/v1, signed as 0x6438/v1: a validator-signed
// claim against one bounded FastPathSettlementRecord escrow row (DR-0137
// "Certified fee escrow and claims"), closed to ZeroShare (tag 1, no leg),
// Split (tag 2, one leg through the policy-pinned `split` entrypoint) or
// FinalTransfer (tag 3, through `transfer`). No Rust encoder is invoked; this
