...
This decision records the rationale and As-Is/To-Be gap at main commit
`362e7974b494125757983f1e90d683dc30eb31d2` (PR #141). The normative target is
split by responsibility across
[`../generic-contracts.md`](../generic-contracts.md),
[`../../smartcontract/lifecycle.md`](../../smartcontract/lifecycle.md), and
[`../../smartcontract/assets-and-fees.md`](../../smartcontract/assets-and-fees.md).
Changing implementation status and the work queue belong only in
[`TODO.md`](../../../TODO.md); this record is not implementation evidence.
